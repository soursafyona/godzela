...
send(msg.chat_id_, msg.id_,' 么لا تستطيع استخدام البوت \n  么يرجى الاشتراك بالقناه اولا \n  么اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
Text_Games = [[
么sَoٰuِِ𝖱ٰcٌe GٓOٰٰDِٓZٰłLٰA 么
⩹━━━━━━ᧁꪮᦔɀ𝓲ꪶꪶꪖ━━━━━━⩺
么مرحب بيك في قائمه الالعاب 么
⩹━━━━━━ᧁꪮᦔɀ𝓲ꪶꪶꪖ━━━━━━⩺
...
✓العاب 
✓العاب السورس 
[sَoٰuِِ𝖱ٰcٌe GٓOٰٰDِٓZٰłLٰA](t.me/B_e_m_0) 
]]
...
𝚆𝙴𝙻𝙲𝙾𝙼𝙴  𝚃𝙷𝙴 𝚂𝙾𝚄𝚁𝙲𝙴 
⩹━━━━━━ᧁꪮᦔɀ𝓲ꪶꪶꪖ━━━━━━⩺
么أنت الآن في العاب السورس么
⩹━━━━━━ᧁꪮᦔɀ𝓲ꪶꪶꪖ━━━━━━⩺
么اوامر الالعاب كتالي 
⩹━━━━━━ᧁꪮᦔɀ𝓲ꪶꪶꪖ━━━━━━⩺
 么تفعيل الالعاب • لتفعيل العبه ° 
 么تعطيل الالعاب • لتعطيل العبه °
⩹━━━━━━ᧁꪮᦔɀ𝓲ꪶꪶꪖ━━━━━━⩺
 么الالعاب الخاصه بسورس 
⩹━━━━━━ᧁꪮᦔɀ𝓲ꪶꪶꪖ━━━━━━⩺
 么لعبه البات ~⪼ لعبة المحيبس 
 么لعبه التخمين ~⪼ لعبة البحث
 么لعبه الاسرع ~⪼ لعبة اسرع شخص
 么لعبه السمايلات ~⪼ لعبة المطابقه 
 么لعبه المختلف ~⪼ لعبة الذكاء
 么لعبه الرياضيات ~⪼ لعبة الارقام
 么لعبه الانكليزي ~⪼ لعبة ترجمه
 么لعبه الامثله ~⪼ لعبة تصحيح 
 么لعبه العكس ~⪼ لعبة عكس الكلمات
 么لعبه الحزوره ~⪼لعبة التفكير 
 么لعبه المعاني ~⪼ العبه الشهيره 
⩹━━━━━━ᧁꪮᦔɀ𝓲ꪶꪶꪖ━━━━━━⩺
]]
keyboard = {} 
...
send(msg.chat_id_, msg.id_,' 么اسرع واحد يدز هاذا السمايل ? » {`'..SM..'`}')
return false
end
end
...
send(msg.chat_id_, msg.id_,' 么الف مبروك لقد فزت \n 么للعب مره اخره ارسل »{ سمايل , سمايلات }')
...
send(msg.chat_id_, msg.id_,' 么اسرع واحد يرتبها » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 么الف مبروك لقد فزت \n 么للعب مره اخره ارسل »{ الاسرع , ترتيب }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_,' 么اسرع واحد يحل الحزوره ↓\n {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 么اسرع واحد يدز معنى السمايل » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 么 الف مبروك لقد فزت \n 么للعب مره اخره ارسل »{ معاني }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_,' 么اسرع واحد يدز العكس » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_," 么عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
...
send(msg.chat_id_, msg.id_,' 么مبروك فزت ويانه وخمنت الرقم الصحيح\n 么تم اضافة { 5 } من النقاط \n')
...
database:del(bot_id..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' 么اوبس لقد خسرت في اللعبه \n 么حظآ اوفر في المره القادمه \n 么كان الرقم الذي تم تخمينه { '..GETNUM..' }')
else
send(msg.chat_id_, msg.id_,' 么اوبس تخمينك غلط \n 么ارسل رقم تخمنه مره اخرى ')
end
end
end
end
...
send(msg.chat_id_, msg.id_,'\n 么اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n'..' 么ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n'..' 么سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ')
...
send(msg.chat_id_, msg.id_," 么عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
local GETNUM = database:get(bot_id.."Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' 么مبروك فزت وطلعت المحيبس بل ايد رقم { '..NUM..' }\n 么لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
database:del(bot_id.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' 么للاسف لقد خسرت \n 么المحيبس بل ايد رقم { '..GETNUM..' }\n 么حاول مره اخرى للعثور على المحيبس')
end
end
end
...
↓      ↓     ↓      ↓     ↓     ↓   
👊 ‹•› 👊 ‹•› 👊 ‹•› 👊 ‹•› 👊 ‹•› 👊
 么اختر لأستخراج المحيبس الايد التي تحمل المحيبس 
 么الفائز يحصل على { 3 } من النقاط *
]]
...
name = string.gsub(name,'⌛️','⏳⏳⏳⏳⏳⏳⌛️⏳⏳')
name = string.gsub(name,'📅','📆📆📆📆📆📆📅📆📆')
send(msg.chat_id_, msg.id_,' 么اسرع واحد يدز الاختلاف » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 么حل المسأله الرياضيه  » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 么ترجم الكلمات الاتيه  » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 么اسرع واحد يكمل المثل » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
