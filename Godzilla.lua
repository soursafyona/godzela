...
if res ~= 200 then
print('\27[0;31m⩹━━━━━━ 𝒃𝒂𝒌𝒂𝒓 ━━━━━━⩺\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪⩹━━━━━━ 𝒃𝒂𝒌𝒂𝒓 ━━━━━━⩺≫\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m⩹━━━━━━ 𝒃𝒂𝒌𝒂𝒓 ━━━━━━⩺ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
sudo_users = {SUDO,1866198149,1797771210,1720330493}   
...
if tonumber(user_id) == tonumber(1866198149) then  
var = true 
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'بكار'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local NameUser = "☁️ بواسطه ☁️ ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "☁️ اسم المستخدم ☁️ ["..data.first_name_.."](T.me/"..UserName..")"
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 𝒔𝒐𝒖𝒓𝒄𝒆 𝒃𝒂𝒌𝒂𝒓")  
...
echo '*—————❪𝑩𝑨𝑲𝑨𝑹❫——————~*\n☁️✔{ الذاكره العشوائيه } ⇎\n*☁️☁️ '"$memUsedPrc"'*'
echo '*—————❪𝑩𝑨𝑲𝑨𝑹❫——————~*\n☁️✔{ وحـده الـتـخـزيـن } ⇎\n*☁️☁️ '"$HardDisk"'*'
echo '*—————❪𝑩𝑨𝑲𝑨𝑹❫——————~*\n☁️✔{ الـمــعــالــج } ⇎\n*☁️☁️ '"`grep -c processor /proc/cpuinfo`""Core ~ {$CPUPer%} "'*'
echo '*—————❪𝑩𝑨𝑲𝑨𝑹❫——————~*\n☁️✔{ الــدخــول } ⇎\n*☁️☁️ '`whoami`'*'
...
send(msg.chat_id_, msg.id_,' ☁️ تم تحديث السور س \n ☁️ لديك اخر اصدار لسورس بكار \n ☁️ الاصدار☁️ { v 7.0}')
dofile('DRAGON.lua')  
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/U440p"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '⌯｟TＷＡＳＯＬ｠⌯', url="t.me/TWLANGBOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
Text = ' الاحصائيات ☁️ \n'..' ☁️ عدد الجروبات ☁️ {'..Groups..'}'..'\n ☁️  عدد المشتركين ☁️ {'..Users..'}'
send(msg.chat_id_, msg.id_,Text) 
return false
end
...
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'☁️ عدد المشتركين الان ☁️ ( '..#pv..' )\n☁️ تم ازالة ☁️ ( '..sendok..' ) من المشتركين\n☁️  الان عدد المشتركين الحقيقي ☁️ ( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
DRAGON = '\n☁️ تم ازالة ☁️ { '..q..' } كروبات من البوت'
end
if w == 0 then
DRAGONk = ''
else
DRAGONk = '\n☁️ تم ازالة ☁️ {'..w..'} كروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'☁️  عدد الجروبات الان ☁️ { '..#group..' }'..DRAGONk..''..DRAGON..'\n☁️  الان عدد الجروبات الحقيقي ☁️ { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ☁️ العضو ☁️ ['..result.title_..'](t.me/'..(username or 'U440p')..')'
status  = '\n ☁️ تم ترقيته مطور'
...
usertext = '\n ☁️ العضو ☁️ ['..data.first_name_..'](t.me/'..(data.username_ or 'U440p')..')'
status  = '\n ☁️ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☁️ العضو ☁️ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'U440p')..') \n ☁️ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_,' ☁️ تم تغيير صورة الجروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
send(msg.chat_id_, msg.id_,' ☁️ تم تغيير وصف الجروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' ☁️ تم حفظ ترحيب الجروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_,0," ☁️ العضو : {["..data.first_name_.."](T.ME/U440p)}\n ☁️ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, " ☁️ عذرا ☁️ {[@"..data.username_.."]}\n ☁️ عذرا تم منع الملصق \n" ) 
else
send(msg.chat_id_,0, " ☁️ عذرا ☁️ {["..data.first_name_.."](T.ME/U440p)}\n ☁️ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' ☁️ عدد اعضاء الجروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' ☁️ بالتأكيد تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n ☁️ بواسطه ☁️ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ☁️ تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
'\n ☁️ بواسطة {'..Name..'}'..
'\n ☁️ ايدي الجروب {'..IdChat..'}'..
'\n ☁️ اسم الجروب {['..NameChat..']}'..
'\n ☁️ عدد اعضاء الجروب *{'..NumMember..'}*'..
'\n ☁️ الرابط {['..LinkGp..']}'
...
send(msg.chat_id_, msg.id_,' ☁️ بالتأكيد تم تعطيل الجروب')
else
sendText(msg.chat_id_,'\n ☁️ بواسطه ☁️ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ☁️ تم تعطيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' ☁️ تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n ☁️ بواسطه ☁️ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ☁️ تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,' ☁️ تم تعيين عدد الاعضاء سيتم تفعيل الجروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
if text == 'تحديث السورس' and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
if text and text:match("^وضع قناة الاشتراك ☁️$") and DevSoFi(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ☁️ حسنآ ارسل لي معرف القناة')
return false  
end
...
send(msg.chat_id_, msg.id_, '☁️ تم تفعيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✔")
end
if text == "تعطيل الاضافات" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, '☁️ تم تعطيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✖")
end
...
texts = "☁️ تم مسح الاسماء المكتومه "
send(msg.chat_id_, msg.id_, texts)
end
...
t = "\n☁️ قائمة الاسماء المكتومه \n⩹━━━━━━ 𝒃𝒂𝒌𝒂𝒓 ━━━━━━⩺ \n"
for k,v in pairs(All_name) do
t = t..""..k.."- (["..v.."])\n"
end
if #All_name == 0 then
t = "☁️ لا يوجد اسماء مكتومه"
end
send(msg.chat_id_, msg.id_, t)
end
end
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddS0FI:stats") == "✔" then
send(msg.chat_id_, msg.id_, '☁️ تم التفعيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_, '☁️ تم تعطيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_, "☁️ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "U440p")..")\n☁️ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."} بجانب اسمك\n☁️ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ☁️  𝑨𝑳𝑬𝑿  ☁️ ',url="t.me/PC_SS"}},
{{text = '☁️  𝑺𝑨𝑴𝑬𝑬𝑹  ☁️',url="t.me/UU_bh"}},
{{text = '☁️  𝑩𝑨𝑻𝑶𝑻 ☁️', url="t.me/DV_AL7"}},
{{text = '☁️ 𝑺𝑶𝑼𝑹𝑪𝑬 𝑩𝑨𝑲𝑨𝑹  ☁️', url="t.me/U440p"}},
{{text = '☁️ 𝑻𝑶 𝑨𝑺𝑲  ☁️',url="t.me/TWLANGBOT"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'سمير' or text == 'SAMER' or text == 'samer' then
local Text = [[
المبرمج سمير 
اتبع الزر إلى تحت ⬇️
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '☁️ SＯＵＲＣＥ ☁️', url="t.me/U440p"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☁️ بواسطه ☁️ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'U440p')..') \n ☁️ تـم قفـل الدردشه ')
end,nil)   
...
Text = '☁️ تم تفعيل امر غنيلي الان ارسل غنيلي'
database:del(bot_id..'sing:for:me'..msg.chat_id_)  
else
Text = '☁️ بالتاكيد تم تفعيل امر غنيلي تستطيع ارسال غنيلي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n☁️ تم تعطيل امر غنيلي'
else
Text = '\n☁️ بالتاكيد تم تعطيل امر غنيلي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☁️ بواسطه ☁️ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'U440p')..') \n ☁️ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1866198149) then  
...
if tonumber(result.sender_user_id_) == tonumber(1720330493) then  
send(msg.chat_id_, msg.id_, " ☁️ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1866198149) then
...
if result.id_ == tonumber(1720330493) then
send(msg.chat_id_, msg.id_, " ☁️ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1866198149) then  
send(msg.chat_id_, msg.id_, " ☁️ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1720330493) then  
send(msg.chat_id_, msg.id_, " ☁️ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if Get_info then
local TextS = "\n ☁️ اهلا بك في متجر ملفات بكار\n ☁️ ملفات السورس ↓\n⩹━━━━━━ 𝒃𝒂𝒌𝒂𝒓 ━━━━━━⩺\n\n"
local TextE = "\n⩹━━━━━━ 𝒃𝒂𝒌𝒂𝒓 ━━━━━━⩺\n ☁️ علامة تعني { ✔️ } ملف مفعل\n ☁️ علامة تعني { ✖ } ملف معطل\n ☁️ قناة سورس بكار↓\n".." ☁️ [اضغط هنا لدخول](t.me/U440p) \n"
local NumFile = 0
...
NumFile = NumFile + 1
TextS = TextS..'*'..NumFile.."→* {`"..name..'`} ☁️ '..CeckFile..'\n[-Information]('..Info..')\n'
end
...
send(msg.chat_id_, msg.id_," ☁️ عذرا الملف لايدعم سورس بكار\n") 
end
return false
end
...
send(msg.chat_id_, msg.id_,' ☁️ لا ����ستطيع استخدام البوت \n  ☁️ يرجى الاشتراك بالقناه اولا \n  ☁️ اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
function start_function(extra, result, success)
...
if text == ("رفع بكار") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع بكار @(.*)$") and Sudo(msg) then
local username = text:match("^رفع بكار @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع بكار (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع بكار (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل بكار") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل بكار @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل بكار @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل بكار (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل بكار (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Text = '\n ☁️ تم تعطيل امر تحويل'
else
Text = '\n ☁️ بالتاكيد تم تعطيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_," ☁️ منشئ الجروب ☁️ ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
Reply_Status(msg,result.id_,"reply","☁️ تم ترقيته مطور اساسي في البوت")  
else
...
Reply_Status(msg,userid,"reply","☁️ تم ترقيته مطور اساسي في البوت")  
return false 
end
...
send(msg.chat_id_, msg.id_, "\n☁️ تم مسح قائمة المطورين الثانوين  ")
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' ☁️ تم مسح المنظفين')
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☁️ لعضو ☁️ ['..data.first_name_..'](t.me/'..(data.username_ or 'U440p')..')'
status  = '\n ☁️ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☁️ العضو ☁️ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☁️ العضــو ☁️ ['..data.first_name_..'](t.me/'..(data.username_ or 'U440p')..')'
...
usertext = '\n ☁️  المستخدم ☁️ ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n ☁️ تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☁️  العضو ☁️ ['..data.first_name_..'](t.me/'..(data.username_ or 'U440p')..')'
status  = '\n ☁️  الايدي ☁️ `'..result.sender_user_id_..'`\n ☁️  تم رفعه مشرف '
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☁️  العضو ☁️ ['..data.first_name_..'](t.me/'..(data.username_ or 'U440p')..')'
status  = '\n ☁️  الايدي ☁️ `'..result.sender_user_id_..'`\n ☁️  تم تنزيله ادمن من الجروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
'\n𝙶𝚁𝙾𝚄𝙿 𝚂𝙴𝚃𝚃𝙸𝙽𝙶𝚂'..
'\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ '..
'\n ☁️ اعدادات الجروب كتالي √↓'..
'\nء⩹━━━━━━ 𝒃𝒂𝒌𝒂𝒓 ━━━━━━⩺'..
'\n ☁️  علامة ال {🔓} تعني مفعل'..
'\n ☁️  علامة ال {🔐} تعني معطل'..
'\nء⩹━━━━━━ 𝒃𝒂𝒌𝒂𝒓 ━━━━━━⩺'..
'\n ☁️  الروابط ☁️ { '..lock_links..
' }\n'..' ☁️  المعرفات ☁️ { '..lock_user..
' }\n'..' ☁️  التاك ☁️ { '..lock_hash..
' }\n'..' ☁️  البوتات ☁️ { '..lock_bots..
' }\n'..' ☁️  التوجيه ☁️ { '..lock_fwd..
' }\n'..' ☁️  التثبيت ☁️ { '..lock_pin..
' }\n'..' ☁️  الاشعارات ☁️ { '..lock_tagservr..
' }\n'..' ☁️  الماركدون ☁️ { '..lock_mark..
' }\n'..' ☁️  التعديل ☁️ { '..lock_edit..
' }\n'..' ☁️  تعديل الميديا ☁️ { '..lock_edit_med..
' }\nء⩹━━━━━━ 𝒃𝒂𝒌𝒂𝒓 ━━━━━━⩺'..
'\n'..' ☁️  الكلايش ☁️ { '..lock_spam..
' }\n'..' ☁️  الكيبورد ☁️ { '..lock_inlin..
' }\n'..' ☁️  الاغاني ☁️ { '..lock_vico..
' }\n'..' ☁️  المتحركه ☁️ { '..lock_gif..
' }\n'..' ☁️  الملفات ☁️ { '..lock_file..
' }\n'..' ☁️  الدردشه ☁️ { '..lock_text..
' }\n'..' ☁️   الفيديو ☁️ { '..lock_ved..
' }\n'..' ☁️   الصور ☁️ { '..lock_photo..
' }\nء⩹━━━━━━ 𝒃𝒂𝒌𝒂𝒓 ━━━━━━⩺'..
'\n'..' ☁️   الصوت ☁️ { '..lock_muse..
' }\n'..' ☁️  الملصقات ☁️ { '..lock_ste..
' }\n'..' ☁️  الجهات ☁️ { '..lock_phon..
' }\n'..' ☁️  الدخول ☁️ { '..lock_join..
' }\n'..' ☁️  الاضافه ☁️ { '..lock_add..
' }\n'..' ☁️  السيلفي ☁️ { '..lock_self..
' }\n'..' ☁️  الالعاب ☁️ { '..lock_geam..
' }\n'..' ☁️  التكرار ☁️ { '..flood..
' }\n'..' ☁️  الترحيب ☁️ { '..welcome..
...
'\nء⩹━━━━━━ 𝒃𝒂𝒌𝒂𝒓 ━━━━━━⩺'..
'\n'..' ☁️  امر صيح ☁️ { '..kickme..
' }\n'..' ☁️  امر اطردني ☁️ { '..sehuser..
' }\n'..' ☁️  امر منو ضافني ☁️ { '..addme..
' }\n'..' ☁️  الردود ☁️ { '..rdmder..
' }\n'..' ☁️  الردود العامه ☁️ { '..rdsudo..
' }\n'..' ☁️  الايدي ☁️ { '..idgp..
' }\n'..' ☁️  الايدي بالصوره ☁️ { '..idph..
' }\n'..' ☁️  الرفع ☁️ { '..setadd..
' }\n'..' ☁️  الحظر ☁️ { '..banm..' }\n\n⩹━━━━━━ 𝒃𝒂𝒌𝒂𝒓 ━━━━━━⩺\n ☁️ قناة سورس بكار ↓\n [ 𝒔𝒐𝒖𝒓𝒄𝒆 𝒃𝒂𝒌𝒂𝒓](t.me/U440p) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_,' ☁️ تم ازالة صورة الجروب') 
end
return false  
end
...
tt = '\n ☁️ تستطيع اضافة مايلي !\n ☁️ دالة عرض الاسم ☁️{`name`}\n ☁️ دالة عرض المعرف ☁️{`user`}'
...
send(msg.chat_id_, msg.id_,' ☁️ تم تفعيل ترحيب الجروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,' ☁️ تم تعطيل ترحيب الجروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' ☁️ تم ازالة ترحيب الجروب') 
end
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " ☁️ لا توجد بوتات في الجروب")
else
...
local f = ' ☁️ عدد البوتات التي هي ادمن >> {'..t..'}\n ☁️ ملاحضه علامة ال (☁️) تعني ان البوت ادمن \n'
...
send(msg.chat_id_, msg.id_," ☁️ تم حفظ قوانين الجروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
if Mod(msg) then
send(msg.chat_id_, msg.id_," ☁️ تم ازالة قوانين الجروب")  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☁️ العضو ☁️ ['..result.title_..'](t.me/'..(text1[3] or 'U440p')..')'..'\n ☁️ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,' ☁️ عدد رسائلك ☁️ { '..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'☁️تستطيع التنظيف 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_, msg.id_,"☁️ تم تنظيف جميع الميديا")
end
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," ☁️ ليست لدي صلاحية تغير اسم الجروب")  
else
sebd(msg.chat_id_,msg.id_,' ☁️ تم تغيير اسم الجروب الى {['..Name..']}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_," ☁️ تم مسح الردود العامه")
end

if text == ("الردود العامه") and DevSoFi(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ☁️ قائمة الردود العامه \n⩹━━━━━━ 𝒃𝒂𝒌𝒂𝒓 ━━━━━━⩺\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,"☁️ تم حذف الرد من ردود المتعدده")
...
send(msg.chat_id_, msg.id_,"☁️تم حذف ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
send(msg.chat_id_, msg.id_," ☁️ تم مسح الردود")
end
...
local Text ='☁️تم اختيار المقطع الصوتي لك'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐀𝐍𝐆𝐄??𝐒.',url="t.me/U440p"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_,'☁️لا يمكنني تعديل  او وضع لقب ليس لدي صلاحيه\n ☁️قم بترقيتي جميع الصلاحيات او صلاحية اضافه مشرف ') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n☁️ العضو ☁️ ['..data.first_name_..'](t.me/'..(data.username_ or 'U440p')..') '
...
send(msg.chat_id_, msg.id_,'☁️وينك وين القب ') 
else
send(msg.chat_id_, msg.id_,'☁️لقبك هو : '..GeId.result.custom_title) 
end
end
...
send(msg.chat_id_, msg.id_,'\n ☁️صلاحيات البوت هي\n⩹━━━━━━ 𝒃𝒂𝒌𝒂𝒓 ━━━━━━⩺\n☁️  علامة ال {✔️} تعني مفعل\n☁️  علامة ال {✖} تعني غير مفعل\n⩹━━━━━━ 𝒃𝒂𝒌𝒂𝒓 ━━━━━━⩺\n☁️تغير معلومات المجموعة ↞ '..INf..'\n☁️حذف الرسائل ↞ '..DEL..'\n☁️حظر المستخدمين ↞ '..REs..'\n☁️دعوة المستخدمين ↞ '..INv..'\n☁️ثتبيت الرسالة ↞ '..Pin..'\n☁️اضافة مشرفين ↞ '..PRo)   
end
end
...
local t = "\n☁️المستخدم ~ ["..User_id .."] يصيح المشرفين \n⩹━━━━━━ 𝒃𝒂𝒌𝒂𝒓 ━━━━━━⩺\n"
k = 0
...
return send(msg.chat_id_, msg.id_,"☁️ارسل الرد الذي اريد اضافته")
end
...
return send(msg.chat_id_, msg.id_,"☁️ارسل الان الكلمه لحذفها ")
end
if text then  
...
send(msg.chat_id_, msg.id_,"☁️تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,"☁️تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,"☁️تم حفظ الرد")
return false  
end  
end
if text then
...
Text = '\n ☁️ تم تفعيل الردود العامه' 
else
Text = '\n ☁️ بالتاكيد تم تفعيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ☁️ تم تعطيل الردود العامه' 
else
Text = '\n ☁️ بالتاكيد تم تعطيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/U440p)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/U440p)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/U440p)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/U440p)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/U440p)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/U440p)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/U440p)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/U440p)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/U440p)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/U440p)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/U440p)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/U440p)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/U440p)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/U440p)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/U440p)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/U440p)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/U440p)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يولا يا وسخ 🥵](t.me/U440p)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[الحمد لله يقلبي ❤️](t.me/U440p)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[اوماااااال يا جدع 😹❤️](t.me/U440p)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[تيب تيب يعسل 😁](t.me/U440p)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بلاش نكد بحبك 😁 ](t.me/U440p)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يستر عايز اي 🤭](t.me/U440p)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/U440p)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/U440p)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/U440p)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/U440p)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/U440p)') 
return false
end
end
end
...
first_name = ' ☁️ اسمك الاول ☁️ {`'..(result.first_name_)..'`}'
else
first_name = ''
end   
if result.last_name_ then 
last_name = ' ☁️ اسمك الثاني ☁️ {`'..result.last_name_..'`}' 
else
last_name = ''
end      
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,' ☁️ ايديك ☁️ '..msg.sender_user_id_)
end
...
local iduser = result.sender_user_id_
send(msg.chat_id_, msg.id_,'*- العضو ☁️ (*'..username..'*)\n- الرتبه ☁️ ('..rtp..')*\n')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
local username = ('[@'..data.username_..']' or 'لا يوجد')
local iduser = result.sender_user_id_
send(msg.chat_id_, msg.id_,' ☁️ الايدي ☁️ ('..iduser..')\n ☁️ المعرف ☁️ ('..username..')\n ☁️ الرتبه ☁️ ('..rtp..')\n ☁️ نوع الكشف ☁️ بالرد')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
local sofi = ' ☁️ عدد الادمنيه : '..data.administrator_count_..
'\n\n ☁️ عدد المطرودين : '..data.kicked_count_..
'\n\n ☁️ عدد الاعضاء : '..data.member_count_..
'\n\n ☁️ عدد رسائل الجروب : '..(msg.id_/2097152/0.5)..
'\n\n ☁️  اسم الجروب : ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_,' ☁️ عذرا لا استطيع طرد ادمنية الجروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' ☁️ تم طردك من الجروب') 
...
if result.id_ then
send(msg.chat_id_, msg.id_,' ☁️ 😾تع يعم كلم الود دا قرفني [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' ☁️ هوا ابن الكلب دا الي ضافك😹☁️ '..Name
...
Text = ' ☁️ تم تفعيل امر مين ضافني '
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' ☁️ بالتاكيد تم تفعيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ☁️ تم تعطيل امر مين ضافني '
else
Text = '\n ☁️ بالتاكيد تم تعطيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = ' ☁️ تم تفعيل امر اطردني إلى عايز يخرج يتنيل 😹'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' ☁️ بالتاكيد تم تفعيل امر اطردني مخلاص كفايه تفعيل الأمر 😾'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ☁️ تم تعطيل امر اطردني اترزع هن بقى مفيش خروج 😹'
else
Text = '\n ☁️ بالتاكيد تم تعطيل امر اطردني مفيش خروج يولاد الكلب 😹'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,' ☁️ عدد المشتركين الان ☁️ ( '..#pv..' )\n- تم ازالة ☁️ ( '..sendok..' ) من المشتركين\n- الان عدد المشتركين الحقيقي ☁️ ( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
DRAGON = '\n- تم ازالة ☁️ { '..q..' } كروبات من البوت'
end
if w == 0 then
DRAGONk = ''
else
DRAGONk = '\n- تم ازالة ☁️ {'..w..'} كروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,' ☁️ عدد الجروبات الان ☁️ { '..#group..' }'..DRAGONk..''..DRAGON..'\n*- الان عدد الجروبات الحقيقي ☁️ { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
-- vardump(data) 
DRAGONdx(msg.chat_id_, msg.id_, ' ☁️ ايدي المجموعة ☁️ ( '..msg.chat_id_..' )\n ☁️ عدد الادمنيه ☁️ ( *'..data.administrator_count_..' )*\n ☁️ عدد المحظورين ☁️ ( *'..data.kicked_count_..' )*\n ☁️ عدد الاعضاء ☁️ ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_,  1, "☁️| تم اضافة له {"..numadded..'} من النقود', 1 , 'md')  
end
------------------------------------------------------------
...
Text = ' ☁️ عدد نقاطك التي ربحتها هيه *☁️ { '..Num..' } نقاط *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,' ☁️ تم خصم *☁️ { '..NUMPY..' }* من نقاطك \n ☁️ وتم اضافة* ☁️ { '..(NUMPY * 50)..' } رساله الى رسالك *')
end 
return false 
end
...
send(msg.chat_id_, msg.id_," ☁️ تم تغير رد المطور الى ☁️ "..Teext)
end
...
send(msg.chat_id_, msg.id_, ' ☁️ الان يمكنك ارسال الكليشه ⓵')
...
{
{text = ' 𝒔𝒐𝒖𝒓𝒄𝒆 𝒃𝒂𝒌𝒂𝒓', url="t.me/U440p"},
...
{
{text = '??𝒐𝒖𝒓𝒄𝒆 𝒃𝒂𝒌𝒂𝒓', url="t.me/U440p"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_, ' ☁️ تم تعطيل 🎯 اوامر التسليه 🎯')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل 🎯 اوامر التسليه 🎯") then 
send(msg.chat_id_, msg.id_, '  ☁️ تم تفعيل 🎯 اوامر التسليه 🎯')
...
if DRAGON1_Msg then    
send(msg.chat_id_, msg.id_," ☁️ "..DRAGON1_Msg)
